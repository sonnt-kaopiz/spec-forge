...
- [ ] `templates/external-research.md` — external research template:
  - Technology References (Laravel/Yii2), Similar Implementations, Best Practices, Recommendations
- [ ] `templates/architecture.md` — architecture template:
  - Approach, Component Design (with PHP interfaces), Data Flow, Database Changes, API Changes, Cross-Service Impact, Testing Strategy, Rejected Alternatives, Developer Approval
