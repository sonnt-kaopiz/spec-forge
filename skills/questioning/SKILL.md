---
name: questioning
description: Collaborative dream-extraction questioning for project initialization. Use this skill whenever starting a new project, running `/forge:new`, gathering initial requirements, helping a user articulate a fuzzy idea, or conducting discovery conversations before writing a PROJECT.md or spec. Trigger even if the user doesn't explicitly ask for "questioning" — any time you're about to interview a user about what they want to build, load this first to shape the conversation.
---
